...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/redis/flexsearch.min.js');loadScript('/redis/en.search-data.min.40614fec9b868ec2fad91c688dc008dfa15a71c72a36bd0385897f80cebae4dd.js',function(){input.required=false;search();});}
