...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/redis/flexsearch.min.js');loadScript('/redis/en.search-data.min.25c372fcfb995521fd824fd0d1436eb15043e0245b65d2267af4c4c980bea5f4.js',function(){input.required=false;search();});}
